          ...
          <SubContainer>
            ...
            <DetailsContainer className="project-section">
              ...
              <p>
                ...
                tasks and discussing about any blockers that we encountered.
                After each step done, it was updated on our TRELLO in order to
                keep track of remaining requirements for the project.
              </p>
              <p>
            ...
            <LessonsContainer className="project-section">
              <h3>Lessons</h3>
              <p>
                This project was a great opportunity to collaborate as a team on
                a React project. The challenging part was the version
                controlling and managing conflicts when merging several pull
                requests. This was a benefic and challenging project because it
                helped us to improve team communication and collaborate in a
